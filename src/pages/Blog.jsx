          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-16">
                ...
                <button
                  ...
                  className={`px-5 py-2 rounded-full font-syne font-bold text-xs transition-all duration-200 ${
                    selectedCategory === cat
                      ? 'bg-[#fe5e3a] text-white shadow-sm'
            ...
            <div className="relative w-full md:w-72">
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-full bg-white border border-gray-200 text-sm font-outfit focus:outline-none focus:border-[#fe5e3a] transition-colors"
              />
              ...
              >
                <div>
                  <div className="h-60 rounded-2xl overflow-hidden mb-6 bg-gray-100 relative">
                    ...
                    />
                    <span className="absolute top-4 left-4 bg-[#fe5e3a] text-white px-3.5 py-1 rounded-full text-xs font-syne font-bold">
                      {art.category}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-4 text-xs font-outfit text-gray-500 mb-3">
                    <span className="flex items-center gap-1.5">
                      <FaCalendarAlt className="text-[#fe5e3a]" /> {art.date}
                    </span>
                    <span>•</span>
                    <span className="flex items-center gap-1.5">
                      <FaUser className="text-[#fe5e3a]" /> {art.author}
                    </span>
                  </div>

                  <h3 className="font-syne font-bold text-xl sm:text-2xl text-gray-900 group-hover:text-[#fe5e3a] transition-colors mb-3 leading-snug">
                ...
                <div className="pt-4 border-t border-gray-100">
                  <Link
                    to="/blog-details"
                    className="inline-flex items-center gap-2 font-syne font-bold text-xs text-[#0c0c0c] group-hover:text-[#fe5e3a] transition-colors uppercase tracking-wider"
                  >
